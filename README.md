...
- **Source:** [Project Gutenberg #1581](https://www.gutenberg.org)
- **Status:** Public Domain (Challoner Revision, 1749-1752)
- **Format:** Logseq-optimized Markdown (.md)
...
- **Pre-configured Metadata:** Includes properties for easy querying (e.g., searching by Testament or Author).
